...
def a_star_search_euclidean(start, goal):
    def heuristic(state, goal):
        ...
        for i in range(n):
            for j in range(n):
                ...
                distance += math.sqrt((goal_x - i) ** 2 + (goal_y - j) ** 2)
        return distance
...
#
#
# path, nodes_expanded, depth, runtime = a_star_search_euclidean(initial_state, goal_state)
#
# if path:
